        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="mt-8 flex justify-between">
              ...
              {step < 3 ? (
                <Button onClick={() => setStep(step + 1)} className="gradient-accent border-0 text-primary-foreground">
                  Next <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              ) : (
                <Button onClick={() => navigate("/dashboard")} className="gradient-accent border-0 text-primary-foreground">
