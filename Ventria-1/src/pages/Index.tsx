          ...
          >
            ...
            <motion.div variants={fadeUp} custom={2} className="mt-8 flex flex-wrap justify-center gap-3">
              <Button size="lg" asChild className="bg-background text-foreground hover:bg-secondary border-0">
                <Link href="/onboarding">Patient Sign Up</Link>
              </Button>
      ...
      <footer className="border-t border-border/30 py-8">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 sm:flex-row">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-sm font-semibold text-foreground">Ventria</span>
          </div>
          <p className="text-xs text-muted-foreground">© 2026 Ventria. HIPAA-Compliant. All rights reserved.</p>
